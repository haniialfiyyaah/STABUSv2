...
public class KebutuhanHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    TextView nameText;
    TextView jumlahText;
    TextView hargaText;
    private OnListener onListener;

    KebutuhanHolder(@NonNull View itemView, OnListener onListener) {
        super(itemView);
